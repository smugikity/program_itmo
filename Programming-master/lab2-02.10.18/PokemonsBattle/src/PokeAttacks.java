...
class ScaryFace extends PhysicalMove {
    ...
    @Override
    protected String describe(){
        return "уменьшить скорость цели на 2 ступени";
    }
}
...
class Amnesia extends PhysicalMove {
    ...
    @Override
    protected String describe(){
        return "увеличивать особую защиту пользователя на 2 ступени";
    }
}

class SwordsDance extends PhysicalMove {
    ...
    @Override
    protected String describe() {
        return "увеличивать атаку пользователя на 2 ступени";
    }
}

class DoubleTeam extends PhysicalMove {
    ...
    @Override
    protected String describe() {
        return "увеличивать уклонение пользователя на 1 ступени";
    }
}

class RockPolish extends PhysicalMove {
    ...
    @Override
    protected String describe() {
        return "увеличивать скорость пользователя на 2 ступени";
    }
}
...
class Bulldoze extends PhysicalMove{
    ...
    @Override
    protected String describe(){
        return "уменьшить скорость цели на 1 ступени";
    }
}
...
class Psychic extends PhysicalMove {
    ...
    @Override
    protected String describe(){
        return "имеет 10% шанс уменьшить особую защиту цели на 1 ступени";
    }
}

class ShadowBall extends PhysicalMove {
    protected ShadowBall(){
        super(Type.GHOST,80,100);
    }
    @Override
    ...
    @Override
    protected String describe(){
        return "имеет 20% шанс уменьшить особую защиту цели на 1 ступени";
    }
}
